...
const Card = ({event,hasOrderLink,hidePrice}:CardProps) => {
  ...
  return (
    <div className='group relative flex min-h-[380px] w-full max-w-[400px] flex-col rounded-xl bg-white overflow-hidden shadow-md transition-all hover:shadow-lg md:min-h-[438px]'>
        <Link 
            href={`/events/${event._id}`} 
            style={{backgroundImage: `url(${event.imageUrl})`}}
            className='flex flex-grow bg-green-50 bg-center bg-cover text-grey-500'
        />
